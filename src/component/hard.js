...
const [aa2,saa2]=useState('');
const [bb,sbb]=useState('');
const [bb1,sbb1]=useState('4');
const [bb2,sbb2]=useState();
...
const [cc,scc]=useState('6');
const [cc1,scc1]=useState('');
const [cc2,scc2]=useState();
const [dd,sdd]=useState('');
const [dd1,sdd1]=useState(5);
const [dd2,sdd2]=useState('');

const [e,se]=useState('');
const [e1,se1]=useState('');
const [e2,se2]=useState('');
const [f,sf]=useState('');
const [f1,sf1]=useState('');
const [f2,sf2]=useState('1');
...
const [ff,sff]=useState('');
const [ff1,sff1]=useState('');
const [ff2,sff2]=useState('');
  ...
  <Navbar.Collapse id="navbarScroll">
    ...
    >
                      ...
                      <div className="contain">
                        <div className="left" id="t1"><Board topbottom="25px" color="white" a={a} sa={sa} /></div><div className="left"><Board a={a1} sa={sa1}  color="white"/></div>
                        <div className="left"><Board  a={a2} sa={sa2} dis={true} color="#ffdde1"/></div>
                                       
                                              {/* second box  */}
                        
                        <div className="left"><Board a={b} sa={sb} color="white" /></div><div className="left"><Board a={b1} sa={sb1} color="white"/></div>
                        <div className="left"><Board topright="25px" a={b2} sa={sb2} color="white"/></div>
                        
                                              {/* first box colunm 1  */}
                        <div className="left" id="t2"><Board a={aa} sa={saa}  color="white"/></div><div className="left"><Board a={aa1} sa={saa1} color="white"/></div>
                        <div className="left"><Board a={aa2} sa={saa2} color="white"/></div>
                        
                                              {/* second box colunm 1  */}

                        <div className="left"><Board a={bb} sa={sbb} color="white" /></div><div className="left"><Board a={bb1} sa={sbb1} dis={true} color="#ffdde1"/></div>
                        <div className="left"><Board a={bb2} sa={sbb2}  color="white"/></div>

                                                {/* third box  */}

                      <div className="left" id="t3"><Board a={c} sa={sc} color="white"/></div><div className="left"><Board a={c1} sa={sc1}  color="white"/></div>
                        <div className="left"><Board a={c2} sa={sc2} color="white"/></div>
                      ...
                      <div className="left" id="t4"><Board a={cc} sa={scc} dis={true} color="#ffdde1"/></div><div className="left"><Board a={cc1} sa={scc1}  color="white"/></div>
                        <div className="left"><Board a={cc2} sa={scc2}  color="white"/></div>
                                       
                                              {/* fourth box colunm 1 */}
                        
                        <div className="left"><Board a={dd} sa={sdd}  color="white" /></div><div className="left"><Board a={dd1} sa={sdd1} dis={true} color="#ffdde1"/></div>
                        <div className="left"><Board a={dd2} sa={sdd2} color="white"/></div>
                        
                                              {/* fiveth box  */}
                        <div className="left" id="t5"><Board a={e} sa={se}  color="white"/></div><div className="left"><Board a={e1} sa={se1} color="white"/></div>
                        <div className="left"><Board a={e2} sa={se2} color="white"/></div>
                        
                                              {/* sixth box  */}

                        <div className="left"><Board a={f} sa={sf} color="white" /></div><div className="left"><Board a={f1} sa={sf1} color="white"/></div>
                        <div className="left"><Board a={f2} sa={sf2} dis={true} color="#ffdde1"/></div>
                      ...
                      <div className="left" id="t6"><Board bottomleft="25px" a={ee} sa={see} color="white"/></div><div className="left"><Board a={ee1} sa={see1} dis={true} color="#ffdde1"/></div>
                        ...
                        <div className="left"><Board a={ff} sa={sff}  color="white" /></div><div className="left"><Board a={ff1} sa={sff1}  color="white"/></div>
                        <div className="left"><Board bottomright="25px" a={ff2} sa={sff2}  color="white"/></div>
                        </div>
                        </Col></Row>
