...
const [ee1,see1]=useState('');
const [ee2,see2]=useState('');
const [ff,sff]=useState('');
const [ff1,sff1]=useState(2);
  ...
  <Navbar.Collapse id="navbarScroll">
    ...
    >
                      ...
                      <div className="contain">
                        <div className="left" id="t1"><Board topbottom="25px" color="#ffdde1" a={a} sa={sa} dis={true}/></div><div className="left"><Board a={a1} sa={sa1} color="white"/></div>
                      ...
                      <div className="left" id="t3"><Board a={c} sa={sc} color="white"/></div><div className="left"><Board a={c1} sa={sc1}  color="white"/></div>
                        ...
                        <div className="left"><Board a={d} sa={sd} dis={true} color="#ffdde1" /></div><div className="left"><Board a={d1} sa={sd1} color="white"/></div>
                      ...
                      <div className="left" id="t4"><Board a={cc} sa={scc} color="white"/></div><div className="left"><Board a={cc1} sa={scc1}  color="white"/></div>
                        <div className="left"><Board a={cc2} sa={scc2} dis={true} color="#ffdde1"/></div>
                      ...
                      <div className="left" id="t6"><Board bottomleft="25px" a={ee} sa={see} color="white"/></div><div className="left"><Board a={ee1} sa={see1} color="white"/></div>
                        <div className="left"><Board a={ee2} sa={see2} color="white"/></div>
                                       
                                              {/* sixth box colounm 1  */}
                        
                        <div className="left"><Board a={ff} sa={sff}  color="white" /></div><div className="left"><Board a={ff1} sa={sff1} dis={true} color="#ffdde1"/></div>
